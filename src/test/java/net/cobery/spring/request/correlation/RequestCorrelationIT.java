 ...
 * under the License.
 */
package net.cobery.spring.request.correlation;

import static org.assertj.core.api.Assertions.assertThat;

import net.cobery.spring.request.correlation.demo.DemoApplication;
import net.cobery.spring.request.correlation.demo.DemoConfiguration;
