...
/**
 * Configures any {@link RestTemplate} bean by adding a request interceptor to any
 * {@link RestTemplate} beans if it finds the RestTemplate in the class path, and we haven't
 * disabled it in the properties.
 *
