...
public class RequestCorrelationConfiguration {
   /** The properties to use when configuring the filter. */
     ...
     */
    @Bean
    public FilterRegistrationBean<RequestCorrelationFilter> requestCorrelationFilterBean(RequestCorrelationFilter correlationFilter) {
        final FilterRegistrationBean<RequestCorrelationFilter> filterRegistration = new FilterRegistrationBean<>();
