 ...
 * <p>
 * To use {@code RequestCorrelationInterceptor}, applications simply need to declare a bean that
...
public interface RequestCorrelationInterceptor {
    ...
    /**
     * Callback method called whenever the correlation ids have been assigned for the current
     * request, whether they have been set from the request header new ids have been generated for
