...
/**
 * {@link RestTemplate} http interceptor, that propagates the currents thread bound request identifier to
 * the outgoing request, through the 'X-Session-Id' and 'X-Request-Id' headers.
 *
